...
SET REPO_NAME=customized-bedrock-gateway-lambda
...
cd src
docker build --progress=plain --platform linux/arm64 -f Dockerfile -t %IMAGE_NAME% .
cd ..
...
@echo Docker image for Lambda Gateway pushed to: %IMAGE_NAME%
pause
